...
fn main() {
	...
	/*
		I use this to print a random Must to copy somewhere
	*/
...
fn test_Ord_Eq(){
	...
	/*
		Make the Must for adding a new document
	*/
	let must1 = must::Must::new_must();
	
	/*
		Make a Must for a new version of an existing document
	*/	
...
fn test_to_str() {
	...
	/*
		Make sure the key, sec and nsec values are always contained in  
		to_str()
	*/	
